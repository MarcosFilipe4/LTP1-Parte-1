...
joao = Estudante("marcos", 19, 7.9,"001")
marcos = Estudante("felipe", 30, 9,"002")
felipe = Estudante("joao", 16, 9.1,"003")
luiz = Estudante("Luiz", 20, 8,"004")

ltp1 = Turma_Estudantes()

ltp1.adicionar_estudante(marcos)
ltp1.adicionar_estudante(felipe)
...
marcos.alterar_nota(10)
print(ltp1.informacoes(marcos))
print(ltp1.melhor_estudante())